...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <section class="content">
            ...
            $result = mysqli_query($con, "SELECT * FROM payroll_table WHERE payroll_user_id='$pnumber' ORDER BY payroll_id ASC"); // using mysqli_query instead
            ?>
            ...
            <table  border=0 cellpadding="1" cellspacing="1" id="" width="100%" class="table table-hover table-striped">
                ...
                while($res = mysqli_fetch_array($result)) {
                    ...
                    echo "<td class='active'>".$res['payroll_id']."</td>";
                    echo "<td>".$res['payroll_user_id']."</td>";
                    echo "<td>".$res['payroll_hours_worked']."</td>";
                    echo "<td>".$res['payroll_date']."</td>";
